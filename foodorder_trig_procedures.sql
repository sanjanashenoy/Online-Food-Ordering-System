...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2022 at 06:13 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `getOrders` (IN `RID` INT)  SELECT order_ID,F_ID,foodname,price,quantity,order_date,username, R_ID FROM orders WHERE R_ID = RID$$
...
('joshita', 'Joshita', 'josh@gmail.com', '9876549876', 'Bangalore', '123'),
...
(80, 88, 'Sizzling Brownie', 200, 1, '2022-01-10', 'joshita', 8),
(81, 86, 'Waffle', 170, 1, '2022-01-10', 'joshita', 8),
(82, 87, 'Pancakes', 200, 1, '2022-01-11', 'joshita', 8),
(83, 84, 'Coffee', 30, 1, '2022-01-11', 'joshita', 7),
(84, 82, 'Chole Bhature', 120, 1, '2022-01-11', 'joshita', 7),
(85, 87, 'Pancakes', 200, 1, '2022-01-11', 'joshita', 8),
(86, 84, 'Coffee', 30, 1, '2022-01-11', 'joshita', 7),
(87, 82, 'Chole Bhature', 120, 1, '2022-01-11', 'joshita', 7),
(88, 83, 'Idly', 60, 1, '2022-01-11', 'joshita', 7),
(89, 87, 'Pancakes', 200, 1, '2022-01-11', 'joshita', 8),
(90, 84, 'Coffee', 30, 1, '2022-01-11', 'joshita', 7),
(91, 82, 'Chole Bhature', 120, 1, '2022-01-11', 'joshita', 7),
(92, 83, 'Idly', 60, 1, '2022-01-11', 'joshita', 7),
(93, 80, 'Open Butter Masala Dosa', 100, 1, '2022-01-11', 'joshita', 7),
(94, 89, 'Pizza', 300, 1, '2022-01-11', 'joshita', 8),
(95, 92, 'Pasta', 170, 1, '2022-01-11', 'joshita', 9),
(98, 83, 'Idly', 60, 1, '2022-01-11', 'joshita', 7),
(99, 93, 'Noodles', 190, 1, '2022-01-11', 'joshita', 9);

--
-- Triggers `orders`
--
DELIMITER $$
CREATE TRIGGER `insertLog` AFTER INSERT ON `orders` FOR EACH ROW INSERT INTO view_orders VALUES(New.Order_id,NEW.F_id,NEW.foodname,NEW.price,NEW.quantity,now(),NEW.username,NEW.R_id)
$$
DELIMITER ;
...
--
-- Dumping data for table `view_orders`
--

INSERT INTO `view_orders` (`order_ID`, `F_ID`, `foodname`, `price`, `quantity`, `order_date`, `username`, `R_ID`) VALUES
(98, 83, 'Idly', 60, 1, '2022-01-11', 'joshita', 7),
(99, 93, 'Noodles', 190, 1, '2022-01-11', 'joshita', 9);
