...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> GoFood </span>?</strong>
     <br>
      ...
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
           ...
           <span ><p id="characterLeft">Max Character length : 140 </p></span>
          </div> 
          <!-- <input type="submit" name="submit" type="button" id="submit" name="submit" class="btn btn-primary pull-right id="button"/>     -->
          <input type="submit" name="submit"  class="btn btn-primary pull-right" id="button">
        </form>
