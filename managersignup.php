<html>
  ...
  <head>
    <title> Manager Signup | GoFood </title>
  </head>
   ...
   <p>Get started by creating your account</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading"id="heading"> Create Account </div>
       ...
       <label style="margin-left: 5px;"><a href="managerlogin.php"id="text">Have an account? Login.</a></label>
  ...
  <br>
  <p> GoFood 2023 | &copy All Rights Reserved </p>
  <br>
  </footer>
</html>